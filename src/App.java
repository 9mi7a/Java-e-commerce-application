...
public class App {
    ...
    public  void menu() {
        ...
        it.addproduct(new electronic_product("mac very ez ", 2500, "mac", 1));
                            ...
                            case 3:
                                ...
                                while (te == 0) {
                                    ...
                                    switch (k) {
                                        case 1:
                                            String productToRemove = scanner.nextLine();
                                            a.removeFromcart(productToRemove);
                                            break;
                                        case 2:
                                            a.clearcart();
                                            break;
